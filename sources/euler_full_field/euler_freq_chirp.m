function [ lum ] = euler_freq_chirp( input_args )
%EULER_FREQ_CHIRP Summary of this function goes here
%   Detailed explanation goes here
    ...
    f = @(t) (t < 0.0) .* 0.5 + ((0.0 <= t) & (t < d)) .* (0.5 * (1.0 + sin(2.0 * pi * args.nb_periods * (t / d) .* (t / d)))) + (d <= t) .* 0.5;
    lum = f(t(:));
