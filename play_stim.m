...
% PLAY Function for displaying DMD stimulus.
% path - full path to the .bin and .vec files, including file name
% fr  - frame rate [Hz]
%
% Run example:
% path = 'C:\Users\dmd-stimuli-master\outputs\flash_full_field_100hz';
% frame_rate = 100;
% play_stim(path, frame_rate)
